...
import ma.cam.model.LineIterator;
...
public final class MappingUtil {
	 ...
	 * @throws SQLException
	 */
	protected static List<?> resultSetToBeans(ResultSet resultSet, Class<?> clazz) throws Exception {
		...
		try {
			...
			while (resultSet.next()) {
				nombre++;
				Object bean = resultToBean(resultSet, metaData, clazz);
				if (bean != null) {
					beans.add(bean);
				}
	 ...
	 * @throws SQLException
	 */
	public static Object resultToBean(ResultSet resultSet, ResultSetMetaData metaData, Class<?> clazz)
			throws Exception {
...
//			}
	...
	protected static boolean setAttributeValue(Object proxiedObject, Object value, Method attributeMethod,
		...
		if (attributeClass.equals(Boolean.class) || attributeClass.equals(Boolean.TYPE)) {
			...
			if (valueClass.equals(CLOB.class)) {
				executeMethod(attributeMethod, proxiedObject, new Object[] { MappingUtil.toString((CLOB) value) });
			} else if (valueClass.equals(java.math.BigDecimal.class)) {
				int intValue = ((java.math.BigDecimal) value).intValue();
	...
	public static Object resultSetToBean(ResultSet resultSet, Class jdo) throws Exception {

		ResultSetMetaData metaData = resultSet.getMetaData();
		Object bean = null;
		if (resultSet.next())
			bean = resultToBean(resultSet, metaData, jdo);
	 ...
	 */
	public static byte[] clobToBytes(Clob value) throws Exception {
	 ...
	 * @throws BaseException the base exception
	 */
	public static byte[] blobToBytes(Blob value) throws Exception {
	 ...
	 * @throws BaseException the base exception
	 */
	public static char[] clobToChars(Clob value) throws Exception {
	 ...
	 * @throws BaseException the base exception
	 */
	public static char[] blobToChars(Blob value) throws Exception {
	 ...
	 * @throws BaseException the base exception
	 */
	public static byte[] clobToBytes(Clob value, long start, long length) throws Exception {
	 ...
	 * @throws BaseException the base exception
	 */
	public static byte[] blobToBytes(Blob value, long start, long length) throws Exception {
	 ...
	 * @throws BaseException the base exception
	 */
	public static char[] clobToChars(Clob value, long start, long length) throws Exception {
		String strValue;
	 ...
	 * @throws BaseException the base exception
	 */
	public static char[] blobToChars(Blob value, long start, long length) throws Exception {
		String strValue;
	 ...
	 * @throws BaseException the base exception
	 */
	public static byte[] inputStreamToBytes(InputStream is, long length) throws Exception {
	 ...
	 * @throws BaseException the base exception
	 */
	public static char[] inputStreamToChars(InputStream is, long length) throws Exception {
		DataInputStream in = null;
