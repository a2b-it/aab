...
public class MainRead {
	...
	public static void main(String[] args) {
		...
		//HecDataManager.setDefaultDSSFileName("F:/Workspaces/apigeo/TestHEC/MyDSS_file3.dss");
		try {
			HecDss hecDss = HecDss.open("F:/Workspaces/apigeo/TestHEC/MyDSS_file3.dss");
			TimeSeriesContainer tsc = (TimeSeriesContainer) hecDss.get("");
